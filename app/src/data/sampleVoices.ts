...
export const SAMPLE_VOICES: SampleVoice[] = [
  ...
  { id: 'voc-nora',    name: 'Nora',    description: 'Easy, conversational female voice',
    audioStaticPath: 'female_conv.wav',  imageStaticPath: 'voc-nora.webp' },
  ...
  { id: 'voc-bennett', name: 'Bennett', description: 'Passionate, persuasive male voice',
    audioStaticPath: 'male_conviction.wav', imageStaticPath: 'voc-bennett.webp' },
  ...
  { id: 'voc-quinn',   name: 'Quinn',   description: 'Upbeat, joyful female voice',
    audioStaticPath: 'female_mood1.wav', imageStaticPath: 'voc-quinn.webp' },
