        ...
        <div className="space-y-10 text-[#A7B0B7] leading-7">
          ...
          <section>
            ...
            <ul className="list-disc list-outside pl-6 space-y-2 mb-6">
              ...
              <li>Baseline evaluation pipeline for PromptTTS focused on voice quality validation, voice trait accuracy, content correctness, and environmental consistency</li>
            </ul>
            ...
            <ul className="list-disc list-outside pl-6 space-y-2 mb-6">
              ...
              <li>Baseline evaluation pipeline for STT, Voice Cloning on the subnet</li>
